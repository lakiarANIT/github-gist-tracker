  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-gray-100 text-center mb-8">
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaSearch className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">1. Search Public Gists</h2>
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaFolder className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Group Your Gists</h2>
              <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaBookOpen className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Read Gists Like a Book</h2>
              <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaUserCog className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Manage Your Groups</h2>
              <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaEdit className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">5. Customize Your Profile</h2>
              <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <FaGithub className="w-10 h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Powered by GitHub</h2>
              <p className="text-gray-700 dark:text-gray-300">
        ...
        <div className="text-center mt-12">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Ready to Get Started?</h2>
          {status === "authenticated" ? (
            <Link
              href="/profile"
